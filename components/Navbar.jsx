...
import { AiOutlineHome, AiOutlineShoppingCart, AiOutlineStar, AiOutlineLeft } from "react-icons/ai";
...
export default function Navbar() {
  ...
  console.log(router.pathname === '/product/[id]')
  ...
  return <>
    {
      router.pathname !== '/product/[id]' ?
        <>
          ...
          <nav className={`w-2/3 bg-background_main_l transition-transform duration-300 h-full fixed flex flex-col justify-between
    ...
    top-0 left-0${navShowing ? ' pointer-events-auto opacity-80 ' : ''}`}
        ...
        :
        <div className={`fixed top-4 left-4 z-40 cursor-pointer `} onClick={handleBack}>
