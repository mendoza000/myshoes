...
const Cart = () => {
  ...
  return (
    <div className="container min-h-screen pb-20 bg-background_main animate__animated animate__fadeIn animate__faster md:min-w-[calc(100vw-50px)] md:ml-auto dark:bg-bg_dark">
