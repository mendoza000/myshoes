...
const Cart = () => {
  ...
  return (
    <div className="container min-h-screen pb-20 bg-background_main animate__animated animate__fadeIn animate__faster mx-auto md:min-w-[calc(100vw-50px)] md:ml-auto dark:bg-bg_dark">
      <div className="lg:max-w-4xl md:mx-auto md:max-w-2xl dark:bg-bg_dark">
